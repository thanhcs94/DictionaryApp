...
public class MyarrayaDapterABC extends ArrayAdapter<String>{
...
//	Integer []image;
	...
	public MyarrayaDapterABC(Activity context,
			ArrayList<String>  tu,
			ArrayList<String> nghia,
			ArrayList<String>  phatam,
			ArrayList<String>  loaitu) {
		super(context, R.layout.listtitleabc, tu);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null)
		{
			...
			convertView = inflater.inflate(R.layout.listtitleabc, null);
